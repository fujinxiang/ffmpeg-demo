...
# 图片和音频合成视频
ffmpeg -loop 1 -y -i test2.png -i 门铃声.mp3 -shortest -acodec copy -vcodec libx264 result.mp4
...
main_w 代表视频宽度，overlay_w 代表水印图片宽度，main_w-overlay_w-10 就是视频宽度减水印图片宽度再减 10
main_h 代表视频高度，overlay_h, 代表水印图片高度，main_h-overlay_h-10 就是视频高度减水印图片高度再减 10
